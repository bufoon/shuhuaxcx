package com.rttx.protocol.dubbo.endpoint;

import com.rttx.protocol.dubbo.DubboProperties;
import com.rttx.protocol.dubbo.domain.ClassIdBean;
import com.rttx.protocol.dubbo.listener.ConsumerSubscribeListener;
import com.rttx.protocol.dubbo.listener.ProviderExportListener;
import com.rttx.protocol.dubbo.listener.StaticsFilterHelper;
...
public class DubboEndpoint extends AbstractEndpoint<Map<String, Object>> {
  ...
  public Map<String, Object> getRuntime() {
    ...
    runtimeMap.put("appname", this.dubboProperties.getApplication().getName());
    runtimeMap.put("registry", this.dubboProperties.getRegistry().getAddress());
    runtimeMap.put("protocol", this.dubboProperties.getProtocol().getName());
    runtimeMap.put("port", this.dubboProperties.getProtocol().getPort());
    runtimeMap.put("threads", this.dubboProperties.getProtocol().getThreads());
